...
from synembtrack.EmbedSeg.criterions.lovasz_losses import lovasz_hinge
...
class SpatialEmbLoss(nn.Module):
    ...
    def forward(self, prediction, instances, labels, center_images, w_inst=1, w_var=10, w_seed=1, iou=False,
        ...
        #print("이곳을 보아라")
        #print(prediction.shape, instances.shape, labels.shape, center_images.shape)
